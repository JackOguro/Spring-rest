...
/**
 * @Primary クラスを優先してDIする
 *           ControllerでDIした際に、UserServiceImpl1, 2どちらのメソッドを実装すれば良いか分からなくってしまう
 */
...
public class UserServiceImpl2 implements UserService {
	...
	public List<MUser> getUsers(MUser user) {
		...
		// 検索条件
		// 動的SQLを生成して検索条件を変更するためには、Exampleを用いる
		// findAllメソッドにExampleを渡すことで、検索条件を変更できる。
