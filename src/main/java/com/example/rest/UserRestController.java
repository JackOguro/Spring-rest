...
public class UserRestController {
    ...
    /** ユーザーを検索 */
    @GetMapping("/get/list")
    public List<MUser> gerUserList(UserListForm form) {
    ...
    public RestResult postSignup(@Validated(GroupOrder.class) SignupForm form,
    	...
    	if(bindingResult.hasErrors()) {
    		...
    		// エラーメッセージ取得
    		// バリデーション結果がNGとなったフィールド名称はFieldErrorクラスから取得することができる
    		// ただし取得できるのは単項目チェックに引っかかったフィールド
    		// FieldErrorとLocaleをMessageSourceに渡すとエラーメッセージを取得できる
